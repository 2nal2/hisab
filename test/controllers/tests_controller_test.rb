...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { description: @test.description, status: @test.status, title: @test.title } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { description: @test.description, status: @test.status, title: @test.title } }
