...
class CustomerCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create customer_category" do
    assert_difference('CustomerCategory.count') do
      post customer_categories_url, params: { customer_category: { category_name: @customer_category.category_name } }
    end
  ...
  test "should update customer_category" do
    patch customer_category_url(@customer_category), params: { customer_category: { category_name: @customer_category.category_name } }
